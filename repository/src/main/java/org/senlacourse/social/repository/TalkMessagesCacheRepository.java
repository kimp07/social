...
public interface TalkMessagesCacheRepository extends JpaRepository<TalkMessagesCache, Long> {
    ...
    @Query(value = "select tm.talkMessage.talk as talkMessage, count(tm.talkMessage.talk.id) as talkMessageCount"
    ...
    Page<ITalkMessagesCacheTalksCountView> findAllByRecipientIdAndTalkId(Long recipientId,
                                                                         Long talkId,
                                                                         Pageable pageable);
